...
public class LoggerMessage {
	...
	// public static final String DELETION_ERROR = "Deletion failed";
	 ...
	 //public static final String UPDATE_CUSTOMER_ADDRESS_ERROR = "Error in updating customer address.";
	 public static final String UPDATE_CUSTOMER_ADDRESS_SUCCESSFUL = " Customer address updated.";

	 //AccountmanagementDAOimpl_Additiondone//
	 //public static final String ADD_ADDRESS_ERROR = "Error in adding customer address.";
	 public static final String ADD_ADDRESS_SUCCESSFUL = "Customer Address Details added.";
	// public static final String ADD_CUSTOMER_DETAILS_ERROR = "Error in adding customer details.";
	 public static final String ADD_CUSTOMER_DETAILS_SUCCESSFUL = "Customer Details added.";
	 //public static final String ADD_ACCOUNT_ERROR = "Error in adding customer account.";
