...
public class PassbookMaintenanceQueryMapper {
	...
	public static final String QUERY_SUMMARY = "SELECT trans_id,date, amount, trans_from,trans_to, type, trans_closing_balance JOIN account ON account.account_id= transaction.account_id WHERE transaction.account_id=? AND date BETWEEN ? and ?";
