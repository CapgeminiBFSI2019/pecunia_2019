...
public interface TransactionQueryMapper {
	...
	public static final String INSERT_TRANSACTION_QUERY = "INSERT INTO transaction (account_id,type,amount,trans_option,date,cheque_id,trans_from,trans_to,trans_closing_balance) VALUES (?,?,?,?,NOW(),?,?,?,?)";
